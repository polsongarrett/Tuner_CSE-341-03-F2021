...
exports.postEditProfile = (req, res, next) => {
  ...
  const musicianId = "61aefd2c36317bf3af6d7341";
  const updatedFirstName = "Garrett";
  const updatedLastName = "Polson";
  const updatedCity = "Minot";
  const updatedState = "ND"
  ...
  Musician.findByIdAndUpdate(musicianId, {
